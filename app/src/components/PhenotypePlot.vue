  ...
  data() {
      ...
      methods: {
        async loadPhenotypeData() {
            ...
            let apiUrl = process.env.VUE_APP_API_URL + '/api/statistics/phenotypes_in_cohort';
        ...
        generatePhenotypeGraph() {
            ...
            // first remove svg
            d3.select("#phenotype_dataviz")
                .select("svg")
                .remove();

            // append the svg object to the body of the page
            const svg = d3.select("#phenotype_dataviz")
            .append("svg")
            ...
            // Create a tooltip
            // ----------------
            const tooltip = d3.select("#phenotype_dataviz")
                .append("div")
                .style("opacity", 0)
                .attr("class", "tooltip")
